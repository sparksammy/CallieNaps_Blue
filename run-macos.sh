...
DYLD_INTERPOSE=builds/callienaps_blue_main.so /Applications/Roblox.app/Contents/MacOS/RobloxPlayer
DYLD_INSERT_LIBRARIES=builds/callienaps_blue_main.so /Applications/Roblox.app/Contents/MacOS/RobloxPlayer
echo Done.